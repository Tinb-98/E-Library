...
<html>
    ...
    <center><h3>Auto Biographies Books</h3></center>
    </head>
    <body>
        <center>
        <table width="80%" border="1">
            <tr>
                <th colspan="5"> Live as if you were to die tomorrow. Learn as if you were to live forever – Mahatma Gandhi</th>
            </tr>
            <tr>
             ...
             $sql="SELECT * FROM Books where genre='Auto-Biographies'";
