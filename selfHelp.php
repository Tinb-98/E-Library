...
<html>
    ...
    <center><h3>Self Help</h3></center>
    </head>
    <body>
        <center>
        <table width="80%" border="1">
            <tr>
                <th colspan="5">Teachers open the door, but you must enter by yourself – Chinese Proverb</th>
            </tr>
            <tr>
             ...
             $sql="SELECT * FROM Books where genre='Self-Help'";
