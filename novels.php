...
<html>
    ...
    <center><h3>Novels</h3></center>
    </head>
    <body>
        <center>
        <table width="80%" border="1">
            <tr>
                <th colspan="5">If You are planning for a year, sow rice; if you are planning for a decade, plant trees; if you are planning for a lifetime, educate people – Chinese Proverb</th>
            </tr>
            <tr>
             ...
             $sql="SELECT * FROM Books where genre='Novels'";
