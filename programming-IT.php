...
<html>
    ...
    <center><h3>IT/Programming Books</h3></center>
    </head>
    <body>
        <center>
        <table width="80%" border="1">
            <tr>
                <th colspan="5">Education is the most powerful weapon which you can use to change the world– Nelson Mandela</th>
            </tr>
           <tr>
             ...
             $sql="SELECT * FROM Books where genre='IT/Programming'";
